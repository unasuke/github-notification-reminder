...
class Faye::EventSource
  ...
  def url(); end
  DEFAULT_RETRY = ::T.let(nil, ::T.untyped)
end
...
module Faye::WebSocket::API
  ...
  CLOSE_TIMEOUT = ::T.let(nil, ::T.untyped)
...
class Faye::WebSocket::API::Event
  AT_TARGET = ::T.let(nil, ::T.untyped)
  BUBBLING_PHASE = ::T.let(nil, ::T.untyped)
  CAPTURING_PHASE = ::T.let(nil, ::T.untyped)
end
...
class Faye::WebSocket::Client
  ...
  SECURE_PROTOCOLS = ::T.let(nil, ::T.untyped)
end
...
module Slack::RealTime::Concurrency::Eventmachine
end
...
class Slack::RealTime::Concurrency::Eventmachine::Socket
  ...
  def restart_async(client, new_url); end

  def start_async(client); end
end
